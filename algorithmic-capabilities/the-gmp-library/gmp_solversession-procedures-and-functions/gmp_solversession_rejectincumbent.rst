...
.. seealso::
    ...
    - The procedure :aimms:func:`GMP::Instance::SetCallbackCandidate`. 
    - See :doc:`optimization-modeling-components/implementing-advanced-algorithms-for-mathematical-programs/managing-generated-mathematical-program-instances` of the `Language Reference <https://documentation.aimms.com/language-reference/index.html>`_ for more details on how to install a candidate callback procedure.
