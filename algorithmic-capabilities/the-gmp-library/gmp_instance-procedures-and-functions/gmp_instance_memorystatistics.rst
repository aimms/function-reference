.. aimms:procedure:: GMP::Instance::MemoryStatistics(gmpSet, OutputFileName, AppendMode, MarkerText, ShowLeaksOnly, ShowTotals, ShowSinceLastDump, ShowMemPeak, ShowSmallBlockUsage, doAggregate)
