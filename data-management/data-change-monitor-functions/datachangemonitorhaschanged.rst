...
has been changed since a previous call to :aimms:func:`DataChangeMonitorCreate` or
...
------------
    ...
    :aimms:func:`DataChangeMonitorCreate` or :aimms:func:`DataChangeMonitorReset`. If none of
    ...
    either :aimms:func:`DataChangeMonitorCreate` or :aimms:func:`DataChangeMonitorReset`, these
