...
.. seealso::
    ...
    The element parameter :aimms:set:`CurrentFile`. Files are discussed in :doc:`data-communication-components/text-reports-and-output-listing/the-file-declaration` of
